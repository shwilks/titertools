...
#include "stanExports_sr_effects.h"

RCPP_MODULE(stan_fit4sr_effects_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_sr_effects")
