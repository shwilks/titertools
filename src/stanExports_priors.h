...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_priors");
    ...
    reader.add_event(41, 3, "restart", "model_priors");
    reader.add_event(64, 24, "end", "model_priors");
    return reader;
}
...
class model_priors
  : public stan::model::model_base_crtp<model_priors> {
private:
        double mu_prior_mu;
...
typedef model_priors_namespace::model_priors stan_model;
#ifndef USING_R
