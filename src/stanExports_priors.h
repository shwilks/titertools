...
namespace model_priors_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'priors', line 50, column 2 to column 10)",
                                                      " (in 'priors', line 51, column 2 to column 25)",
                                                      " (in 'priors', line 55, column 2 to column 43)",
                                                      " (in 'priors', line 56, column 2 to column 57)",
                                                      " (in 'priors', line 44, column 2 to column 19)",
                                                      " (in 'priors', line 45, column 2 to column 22)",
                                                      " (in 'priors', line 46, column 2 to column 25)",
                                                      " (in 'priors', line 47, column 2 to column 24)",
                                                      " (in 'priors', line 6, column 2 to column 14)",
                                                      " (in 'priors', line 33, column 4 to line 35, column 6)",
                                                      " (in 'priors', line 31, column 54 to line 37, column 3)",
                                                      " (in 'priors', line 31, column 9 to line 37, column 3)",
                                                      " (in 'priors', line 27, column 4 to line 29, column 6)",
                                                      " (in 'priors', line 25, column 54 to line 31, column 3)",
                                                      " (in 'priors', line 25, column 9 to line 37, column 3)",
                                                      " (in 'priors', line 20, column 4 to line 23, column 6)",
                                                      " (in 'priors', line 18, column 55 to line 25, column 3)",
                                                      " (in 'priors', line 18, column 9 to line 37, column 3)",
                                                      " (in 'priors', line 14, column 4 to line 16, column 6)",
                                                      " (in 'priors', line 12, column 37 to line 18, column 3)",
                                                      " (in 'priors', line 12, column 9 to line 37, column 3)",
                                                      " (in 'priors', line 10, column 4 to column 15)",
                                                      " (in 'priors', line 8, column 46 to line 12, column 3)",
                                                      " (in 'priors', line 8, column 2 to line 37, column 3)",
                                                      " (in 'priors', line 39, column 2 to column 16)",
                                                      " (in 'priors', line 4, column 89 to line 41, column 1)"};
...
class model_priors final : public model_base_crtp<model_priors> {
private:
  double mu_prior_mu;
...
public:
  ...
  inline std::string model_name() const final { return "model_priors"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_priors(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_priors_namespace::model_priors";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_priors_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_priors_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_priors_namespace::model_priors;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_priors_namespace::profiles__;
}
#endif
#endif
