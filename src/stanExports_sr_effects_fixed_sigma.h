...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sr_effects_fixed_sigma");
    ...
    reader.add_event(41, 3, "restart", "model_sr_effects_fixed_sigma");
    reader.add_event(86, 46, "end", "model_sr_effects_fixed_sigma");
    return reader;
}
...
class model_sr_effects_fixed_sigma
  : public stan::model::model_base_crtp<model_sr_effects_fixed_sigma> {
private:
        int N;
        int N_ags;
        int N_srs;
...
public:
    ...
    std::string model_name() const {
        return "model_sr_effects_fixed_sigma";
    }
...
typedef model_sr_effects_fixed_sigma_namespace::model_sr_effects_fixed_sigma stan_model;
#ifndef USING_R
