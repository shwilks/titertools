...
#include "stanExports_compare_crossreactivity_breadth.h"

RCPP_MODULE(stan_fit4compare_crossreactivity_breadth_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_compare_crossreactivity_breadth")
