...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gmt_fixed_sigma");
    ...
    reader.add_event(41, 3, "restart", "model_gmt_fixed_sigma");
    reader.add_event(77, 37, "end", "model_gmt_fixed_sigma");
    return reader;
}
...
class model_gmt_fixed_sigma
  : public stan::model::model_base_crtp<model_gmt_fixed_sigma> {
private:
        int N;
        vector_d upper_lims;
        vector_d lower_lims;
...
typedef model_gmt_fixed_sigma_namespace::model_gmt_fixed_sigma stan_model;
#ifndef USING_R
