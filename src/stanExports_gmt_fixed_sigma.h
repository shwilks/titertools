...
namespace model_gmt_fixed_sigma_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'gmt_fixed_sigma', line 54, column 2 to column 10)",
                                                      " (in 'gmt_fixed_sigma', line 58, column 2 to column 43)",
                                                      " (in 'gmt_fixed_sigma', line 61, column 4 to line 65, column 6)",
                                                      " (in 'gmt_fixed_sigma', line 60, column 17 to line 66, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 60, column 2 to line 66, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 44, column 2 to column 17)",
                                                      " (in 'gmt_fixed_sigma', line 45, column 9 to column 10)",
                                                      " (in 'gmt_fixed_sigma', line 45, column 2 to column 23)",
                                                      " (in 'gmt_fixed_sigma', line 46, column 9 to column 10)",
                                                      " (in 'gmt_fixed_sigma', line 46, column 2 to column 23)",
                                                      " (in 'gmt_fixed_sigma', line 47, column 2 to column 19)",
                                                      " (in 'gmt_fixed_sigma', line 48, column 2 to column 22)",
                                                      " (in 'gmt_fixed_sigma', line 49, column 2 to column 25)",
                                                      " (in 'gmt_fixed_sigma', line 50, column 2 to column 24)",
                                                      " (in 'gmt_fixed_sigma', line 51, column 2 to column 22)",
                                                      " (in 'gmt_fixed_sigma', line 6, column 2 to column 14)",
                                                      " (in 'gmt_fixed_sigma', line 33, column 4 to line 35, column 6)",
                                                      " (in 'gmt_fixed_sigma', line 31, column 54 to line 37, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 31, column 9 to line 37, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 27, column 4 to line 29, column 6)",
                                                      " (in 'gmt_fixed_sigma', line 25, column 54 to line 31, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 25, column 9 to line 37, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 20, column 4 to line 23, column 6)",
                                                      " (in 'gmt_fixed_sigma', line 18, column 55 to line 25, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 18, column 9 to line 37, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 14, column 4 to line 16, column 6)",
                                                      " (in 'gmt_fixed_sigma', line 12, column 37 to line 18, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 12, column 9 to line 37, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 10, column 4 to column 15)",
                                                      " (in 'gmt_fixed_sigma', line 8, column 46 to line 12, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 8, column 2 to line 37, column 3)",
                                                      " (in 'gmt_fixed_sigma', line 39, column 2 to column 16)",
                                                      " (in 'gmt_fixed_sigma', line 4, column 89 to line 41, column 1)"};
...
class model_gmt_fixed_sigma final : public model_base_crtp<model_gmt_fixed_sigma> {
private:
  int N;
...
public:
  ~model_gmt_fixed_sigma() { }
  
  inline std::string model_name() const final { return "model_gmt_fixed_sigma"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gmt_fixed_sigma(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gmt_fixed_sigma_namespace::model_gmt_fixed_sigma";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gmt_fixed_sigma_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gmt_fixed_sigma_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_gmt_fixed_sigma_namespace::model_gmt_fixed_sigma;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_gmt_fixed_sigma_namespace::profiles__;
}
#endif
#endif
