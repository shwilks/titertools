...
#include "stanExports_logdiff_unpaired_me.h"

RCPP_MODULE(stan_fit4logdiff_unpaired_me_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_logdiff_unpaired_me")
